...
```{r}
data <- read_csv(gsub("Markdown_files", "", here("Processed CSV", "oxyco_nor_main.csv")))
# add 'logratios' column (update for each pair)
data$logratios <- data$log_oxyco_nor_ratio

titlestr = "Noroxycodone/Oxycodone"
savestr = "oxyco_nor"
drugname = "Oxycodone"
```
...
# noroxycodone uses the CYP3A4/5 enzymes
...
intlabh1 = 4100 #height position for labels
intlabh2 = 3600
intlabh3 = 1400
...
xwdth = 2.5
xmin = xctr-1.8*xwdth # lower x range
