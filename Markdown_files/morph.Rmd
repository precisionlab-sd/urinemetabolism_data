...
```{r}
data <- read_csv(gsub("Markdown_files", "", here("Processed CSV", "morph_main.csv")))
# add 'logratios' column (update for each pair)
data$logratios <- data$log_morph_ratio

titlestr = "Hydromorphone/Morphine"
savestr = "morph"
drugname = "Morphine"
```
...
# morphine doesn't have an associated enzyme
slow_quant_1 <- 0.02
fast_quant_1 <- 1.00
...
intlabh1 = 750 #height position for labels
intlabh2 = 900
intlabh3 = 1400
...
xmax = xctr+xwdth*2.0 # upper x range
