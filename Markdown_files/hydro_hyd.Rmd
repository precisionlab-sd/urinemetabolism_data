...
```{r}
data <- read_csv(gsub("Markdown_files", "", here("Processed CSV", "hydro_hyd_main.csv")))
# add 'logratios' column (update for each pair)
data$logratios <- data$log_hydro_hyd_ratio

titlestr = "Hydromorphone/Hydrocodone"
savestr = "hydro_hyd"
...
logratios = data_DDIfilt$log_hydro_hyd_ratio

# hydrocodone uses the CYP3A4/5 enzymes
...
intlabh1 = 3200 #height position for labels
intlabh2 = 2800
intlabh3 = 1400
...
xmax = xctr+1.1*xwdth # upper x range
