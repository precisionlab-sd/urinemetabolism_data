...
```{r}
data <- read_csv(gsub("Markdown_files", "", here("Processed CSV", "fenta_main.csv")))
# add 'logratios' column (update for each pair)
data$logratios <- data$log_fenta_ratio

titlestr = "Norfentanyl/Fentanyl"
savestr = "fenta"
drugname = "Fentanyl"
```
...
logratios = data_DDIfilt$log_fenta_ratio

# fentanyl uses the CYP3A4/5 enzymes
...
intlabh1 = 700 #height position for labels
intlabh2 = 600
#intlabh3 = 1400
