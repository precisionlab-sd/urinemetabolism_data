...
```{r}
data <- read_csv(gsub("Markdown_files", "", here("Processed CSV", "mepro_main.csv")))
# add 'logratios' column (update for each pair)
data$logratios <- data$log_mepro_ratio

titlestr = "Meprobamate/Carisoprodol"
savestr = "mepro"
...
# meprobamate does not have enzyme info available
slow_quant_1 <- 0.02
fast_quant_1 <- 1.00
