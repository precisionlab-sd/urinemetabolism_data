...
```{r}
data <- read_csv(gsub("Markdown_files", "", here("Processed CSV", "queti_main.csv")))
# add 'logratios' column (update for each pair)
data$logratios <- data$log_queti_ratio

titlestr = "Norquetiapine/Quetiapine"
savestr = "queti"
drugname = "Quetiapine"
```
...
# quetiapine uses the CYP2D6, CYP3A4/5 enzymes
slow_quant_1 <- 0.054
...
intlabh1 = 1500 #height position for labels
intlabh2 = 1250
intlabh3 = 1000
