...
```{r}
data <- read_csv(gsub("Markdown_files", "", here("Processed CSV", "metha_main.csv")))
# add 'logratios' column (update for each pair)
data$logratios <- data$log_metha_ratio

titlestr = "EDDP/Methadone"
savestr = "metha"
drugname = "Methadone"
```
...
# methadone uses a mix of enzymes; we put CYP34A here
...
intlabh1 = 2100 #height position for labels
intlabh2 = 1800
intlabh3 = 1400
