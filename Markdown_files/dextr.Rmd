...
```{r}
data <- read_csv(gsub("Markdown_files", "", here("Processed CSV", "dextr_main.csv")))
# add 'logratios' column (update for each pair)
data$logratios <- data$log_dextr_ratio

titlestr = "Dextrorphan/Dextromethorphan"
savestr = "dextr"
...
# dextromethorphan uses the CYP2D6 enzyme
slow_quant_1 <- 0.054
fast_quant_1 <- 1-0.018
...
intlabh1 = 540 #height position for labels
intlabh2 = 440
intlabh3 = 400
...
xwdth = 2.8
xmin = xctr-1.3*xwdth # lower x range
