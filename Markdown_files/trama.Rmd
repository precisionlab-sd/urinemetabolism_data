...
```{r}
data <- read_csv(gsub("Markdown_files", "", here("Processed CSV", "trama_main.csv")))
# add 'logratios' column (update for each pair)
data$logratios <- data$log_trama_ratio

titlestr = "O-Desmethyltramadol/Tramadol"
savestr = "trama"
drugname = "Tramadol"
```
...
# tramadol does not have associated enzymes
slow_quant_1 <- 0.02
fast_quant_1 <- 1.00
...
intlabh1 = 1600 #height position for labels
intlabh2 = 1600
intlabh3 = 1400
