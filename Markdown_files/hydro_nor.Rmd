...
```{r}
data <- read_csv(gsub("Markdown_files", "", here("Processed CSV", "hydro_nor_main.csv")))
# add 'logratios' column (update for each pair)
data$logratios <- data$log_hydro_nor_ratio

titlestr = "Norhydrocodone/Hydrocodone"
savestr = "hydro_nor"
...
# norhydrocodone uses the CYP2C9, CYP3A4/5 enzymes
...
intlabh1 = 4500 #height position for labels
intlabh2 = 4000
intlabh3 = 1400
