...
```{r}
data <- read_csv(gsub("Markdown_files", "",here("Processed CSV", "amitr_main.csv")))
# add 'logratios' column (update for each pair)
data$logratios <- data$log_amitr_ratio

titlestr = "Nortriptyline/Amitriptyline"
savestr = "amitr"
...
# amitryptiline uses a mix of enzymes; we use CYP34A here
#slow_quant_1 <- 0.02
#fast_quant_1 <- 1.00
...
intlabh1 = 400 #height position for labels
intlabh2 = 350
intlabh3 = 300
